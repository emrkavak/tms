...
export async function generateMetadata({ params }: SustainabilityPageProps): Promise<Metadata> {
  ...
  return { title: `Sustainability — ${t('siteName')}` };
}
  ...
  return (
    <main className="pt-32 pb-16">
      <div className="mx-auto max-w-[1440px] px-5 sm:px-6 md:px-10 lg:px-16">
        <h1 className="text-4xl font-semibold mb-6">Sustainability</h1>
        <p className="text-muted-foreground">Sustainability information coming here.</p>
      </div>
    </main>
  );
}
